...
angular.module('directive',[])
        .directive('pagecontrol',[function(){
            return {
                ...
                scope:true,
                controller:['$scope','pagecontrolManage',function($scope,pagecontrolManage){
                    $scope.maxPage = 10;
                ...
                resolve:{
                    pagecontrolManage:[function(){
                        ...
                        return new function(){
                            ...
                            this.initPageConrtol = function(maxPage){
                                var arr = [];
