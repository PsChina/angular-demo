...
require('./js/common/service')
angular.bootstrap(document.documentElement, ['bootstrapApp','mainControl','app.left.control','app.right.control','config']) // 注入模块
rem(13.66);

},{"./js/base/rem":2,"./js/common/appLeftController":3,"./js/common/appRightController":4,"./js/common/config":5,"./js/common/javascript":6,"./js/common/mianController":7,"./js/common/service":8}],2:[function(require,module,exports){
function rem(value){
...
require('./service');
var app = angular.module('bootstrapApp', ['ui.bootstrap','ngAnimate','ui.router','service']) // 定义模块

module.exports = app;
},{"./service":8}],7:[function(require,module,exports){
